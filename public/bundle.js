...
/***/ function(module, exports, __webpack_require__) {
	...
	var APP = React.createClass({
	    ...
	    getComponent: function getComponent(index) {
	        ...
	        React.render(React.createElement(SEARCH, { status: this.state.status }), document.getElementById('react-container'));
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(Header, { title: 'Home Page', status: this.state.status }),
	            React.createElement(
	                'button',
	                { onClick: this.getComponent.bind(this, 1) },
	                'Battel'
	            ),
	            React.createElement('div', { id: 'searching-page' })
	        );
	    }
	...
	var SEARCH = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(Header, { title: 'Search Page', status: this.state.status })
	        );
	    }
